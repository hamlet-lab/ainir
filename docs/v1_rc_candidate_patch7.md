...
- Common local temp folders such as `.ainir_local_tmp/`, `.ainir_tmp/`, `ainir_local_tmp_*`, `github_private_trial_results/`, and `ainir_phase*_trial_*/` are ignored during temp-copy setup.
