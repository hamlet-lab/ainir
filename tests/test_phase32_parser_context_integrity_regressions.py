...
def test_complex_yaml_mapping_key_is_invalid_without_traceback(tmp_path: Path) -> None:
...
def test_public_production_context_refuses_handoff_and_lowering() -> None:
...
def test_receipt_id_includes_context_source_and_purpose() -> None:
